        ...
        return (
            <section id='about'>
                <div className = "about-section">
                    ...
                    <p>I am currently starting my development career in the <a href="https://roadtohire.org/" target="_blank" rel="noreferrer" className="job-link">Road to Hire</a> program!</p>
